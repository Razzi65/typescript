...
var units = prompt("Write number of units");
var units1 = Number(units);
var surc = (units1 * .5) * 20 / 100;
var surc2 = (units1 * .75) * 20 / 100;
var surc3 = (units1 * 1.2) * 20 / 100;
var surc4 = (units1 * 1.5) * 20 / 100;
if (units1 <= 50) {
